(function () {
    "use strict";
    angular.module("nexusCore.Web").factory("dataConverter", function ($filter) {
        return {
...
(function () {
    "use strict";
    angular.module("nexusCore.Web").factory("tableFilter", function () {
...
(function () {
    "use strict";
    angular.module("nexusCore.Web").factory("messageBuilder", function () {
        return {
